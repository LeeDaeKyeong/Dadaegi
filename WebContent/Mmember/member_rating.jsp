	...
	$(document).ready(
			function() {
				...
				$("#addItemBtn").click(
						function() {
							// item 의 최대번호 구하기
							var lastItemNo = $("#memberList tr:last")
				...
				<form method="post">
						...
						<thead>
							...
							<tbody>
								<tr height="40px" class="item1">
									...
									<td>-</td>
									<td>명</td>
									<td onClick="window.open('Mdetail.mem?member_id=${member.member_id}','new','width=550px,height=700px,location=no,status=no,scrollbars=no');"><input type="button" value="회원보기" /></td>
									<td
										onClick="window.open('ratingMod.mem?member_id=${member.member_id}','new','width=550px,height=700px,location=no,status=no,scrollbars=no');">
										<input type="submit" value="수정" />
									</td>
								</tr>
								<tr height="40px" class="item2">
									<td><input type="checkbox" id="remove" name="remove"
										value="" /></td>
									<td>우수회원</td>
									<td>모든결제</td>
					...
					<section id="commandCell">
						<input type="button" id="addItemBtn" value="등록" /> <input
							type="button" onClick="fn_delRow('remove');" value="삭제" />
					</section>
